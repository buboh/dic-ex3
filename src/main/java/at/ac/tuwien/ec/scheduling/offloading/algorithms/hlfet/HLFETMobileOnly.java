...
public class HLFETMobileOnly extends OffloadScheduler {
	/**
	 *
	...
	public HLFETMobileOnly(MobileApplication A, MobileCloudInfrastructure I) {
		super();
	...
	public HLFETMobileOnly(Tuple2<MobileApplication, MobileCloudInfrastructure> t) {
		super();
