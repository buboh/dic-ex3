...
public class HLFETEdgeOnly extends OffloadScheduler {
    /**
     *
    ...
    public HLFETEdgeOnly(MobileApplication A, MobileCloudInfrastructure I) {
        super();
    ...
    public HLFETEdgeOnly(Tuple2<MobileApplication, MobileCloudInfrastructure> t) {
        super();
